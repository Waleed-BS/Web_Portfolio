...
import flashcards_gif from '../../assets/images/gifs/Flashcards.gif'
import data_displayer_gif from '../../assets/images/gifs/Data_Displayer.gif'
import Readable_gif from '../../assets/images/gifs/Readable.gif'
import MyReads_gif from '../../assets/images/gifs/MyReads.gif'
...
import redhat_icon from '../../assets/images/icons/redhat.png'
...
const Projects = () => (
  <div id="Projects" className="section">
        ...
        <div className="subtitle-container">
          ...
          <div className="links-container">
            <a
              ...
              href="https://cs.newpaltz.edu/~n02575037/BenjaminCenter/program.php?program_id=66"
            >
              <span>LIVE</span>
            </a>
    ...
    <div className="inner-container">
      ...
      <div className="bottom-container">
        <p>
          ...
          Users can create decks of unlimited flashcards to quiz themselves and
          receive score. Users can also get notifications to remind them to
          study.
        </p>
      </div>
    </div>
    ...
    <div className="inner-container">
      ...
      <div className="bottom-container">
        <p>
          I developed a responsive Single-Page App where users can create posts
          under a chosen category, comment on posts, edit/delete or vote on
          posts or comments, and sort posts or comments by time or votes.
        </p>
      </div>
    </div>
    ...
    <div className="inner-container">
      ...
      <div className="bottom-container">
        <p>
          ...
          express.js back-end server, then categorize them by “read,” “currently

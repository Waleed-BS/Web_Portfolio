      ...
      <div id="WorkExperience" className="section experience">
        ...
        <div className="experience__list-container">
          <ul>
            ...
            <li>
              Built a multiplayer server on a <span>Node.js</span> backend using
              WebSocket protocol to provide real-time communication between
              players and server.
            </li>
            <li>
              Implemented the client side of the game by taking advantage of{' '}
              <span>React</span> components along with <span>Redux</span>{' '}
              for managing the state of players and rooms.
            </li>
            <li>
            ...
            <li>
              This project assisted members of Department of Computer Science by
              utilizing it as a part of a research project.
            </li>
          </ul>
        </div>
        ...
        <div className="experience__list-container">
          <ul>
            ...
            <li>
              ...
              speed up and enhance the process of SROI and EI surveys.{' '}
            </li>
          </ul>
        </div>
      </div>

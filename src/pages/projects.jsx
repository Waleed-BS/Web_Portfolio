  ...
  <Layout location={location}>
    <div id="Projects" className={'projects'}>
      ...
      <h2 className={'projects__md-heading headline-focus-animation'}>
        These are my{' '}
        <span className="projects__md-heading__span">projects</span>
      </h2>
        ...
        /> */}
          ...
          <div className="bottom-container">
            <p>
              ...
              response to hearing English words in a non-native language.
              Players are able to play Word Families Online by creating or
              joining a room of two people after specifying their name and
              native country.
            </p>
          </div>
        </div>
        ...
        /> */}
          ...
          <div className="bottom-container">
            <p>
              ...
              (SROI) and Economic Investment (EI) surveys. It allows
              administrator to have full control over managing surveys while
              limiting the access of regular users.
            </p>
          </div>
        </div>
        <div className="inner-container">
        ...
        <div className="inner-container">
          ...
          <div className="bottom-container">
            <p>
              ...
              posts under a chosen category, comment on posts, edit/delete or
              vote on posts or comments, and sort posts or comments by time or
              votes.
            </p>
          </div>
        </div>
